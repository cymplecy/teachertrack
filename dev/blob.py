...
width =320
height = 240
#cv2.SetCaptureProperty(cap,cv2.CV_CAP_PROP_FRAME_WIDTH,width)    

#cv2.SetCaptureProperty(cap,cv2.CV_CAP_PROP_FRAME_HEIGHT,height) 
...
while(1):
    ...
    #yellow
    #thresh = cv2.inRange(hsv,np.array((28, 80, 80)), np.array((30, 255, 255)))
    thresh = cv2.inRange(hsv,np.array((0, 128, 128)), np.array((5, 255, 255)))
    thresh2 = thresh.copy()
